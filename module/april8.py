...
_logo_line_3_ = ('%s| |) | |\/| | _ \ _|  %s│   %s• Code By MR-Xyaa •   %s│'%(_P_,_U_,_P_,_U_))
_logo_line_4_ = ('%s|___/|_|  |_|___/_|   %s│ %sGithub.com/MR-Xyaa %s│'%(_P_,_U_,_P_,_U_))
_logo_line_5_ = ('%s MR-Xyaa CODE 2022    └─────────────────────────┘'%(_U_))
def _my_logo_():
